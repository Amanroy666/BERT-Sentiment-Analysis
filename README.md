...
Multi-class sentiment analysis with fine-tuned BERT achieving 93% F1-score on customer reviews
...
```bash
git clone https://github.com/Amanroy666/BERT-Sentiment-Analysis.git
